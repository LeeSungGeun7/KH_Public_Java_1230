    ...
    public static void main(String[] args) {
        ...
        while (!msgQueue.isEmpty()){
            ...
            switch(msg.command){
                ...
                case "KaKao": System.out.println(msg.to+"에게 카톡을 보냅니다.");break;
            }
        }
    }
}
