...
// distinct() : 요소의 중복 제거 (내부적으로 equals() 메서드 사용)
...
public class StreamEx6 {
    public static void main(String[] args)  {
        ...
        // limit() : 해당 스트림의 첫 번째 요소부터 전달된 개수만큼의 요소만으로 이루어진 새로운 스트림을반환
        IntStream stream4 = IntStream.range(0,10);
        stream4.limit(5).forEach(n->System.out.print(n+" "));
        // skip() : 해당 스트림의 첫번째 요소부터 전달된 개수만큼의 요소를 제외한
        //          나머지 요소만으로 이루어진 스트림 반환
        ...
        stream7.sorted().forEach(s -> System.out.println(s + " "));
        System.out.println();
