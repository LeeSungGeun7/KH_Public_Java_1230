...
public class StringEx {
    public static void main(String[] args) {
        // equals() : 두개의 문자열이 동일여부를 비교하여 확인하는 결과를 반환
        String a = "hello";
        String b = "java";
        String c = "hello";
//        System.out.println(a.equals(b)); // a 문자열과 b 문자열을 비교해서 결과가 같으면 트루
//        System.out.println(a.equals(c));
//        System.out.println(a.equalsIgnoreCase("HELLO")); // 대소문자 구분하지 않음
//        System.out.println(a == c);

        // indexOf(): 문자열에서 특정 문자/문자열 가 시작되는 인덱스를 리턴(반환) 합니다. (인덱스는 0부터 시작)
        String d = "Hello J Java";
        ...
        // substring(시작인덱스) : 문자열에서 특정 문자를 추출할 때 사용 (시작 인덱스 부터 끝까지)
        ...
        String str3 = "a:b:c:d";
        String[] result = str3.split(":"); // 입력받은 이름을 공백 기준으로 나누어 담음
