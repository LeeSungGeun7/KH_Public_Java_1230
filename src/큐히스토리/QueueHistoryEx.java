...
public class QueueHistoryEx {
    ...
    public static void main(String[] args) {
        ...
        while(true){
            ...
            if(cmd.equalsIgnoreCase("q")){ //대소문자 구분하지않고 q가 입력되면 종료
                System.exit(0); // 프로그램 강제종료 (System Call)
            } else if(cmd.equalsIgnoreCase("help")){
                System.out.println("help - 도움말을 보여줍니다.");
                System.out.println("q/Q - 프로그램 종료");
                System.out.println("history - 최근 입력한 명령어를 "+MAX_SIZE+"개 만큼 보여줍니다.");
    ...
    void save(String cmd) {
        ...
        if(queue.size() > MAX_SIZE) {
            System.out.println("큐의 개수 초과");
            queue.remove(); // 큐의 맨앞의 요소를 제거
        }
    }
}
